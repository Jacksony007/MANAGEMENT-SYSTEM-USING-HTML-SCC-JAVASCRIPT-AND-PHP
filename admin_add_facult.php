...
<body>
    <section id="studentnav">
        ...
        <div class="Admin_dashboard">
            <ul>
                ...
                <li><a class="active" href="#">Add Staff</a></li>
    ...
    <section id="add_members">
        <h1>ADD FACULT</h1>
        <form id="registration_Form" action="register_staff.php" method="post" class="form-container"
            ...
            <input type="text" id="specialization" name="specialization" required placeholder="Specialization">
