...
<body>
    ...
    <section id="add_members">
        <h1>ADD COURSE</h1>
        <form id="registration_Form" action="add_course.php" method="post" class="form-container">
            <input type="text" id="course" name="course" required placeholder="Course Name">
            <div id="courseError" class="error"></div>
            <input type="text" id="department" name="department" required placeholder="Department Name">
