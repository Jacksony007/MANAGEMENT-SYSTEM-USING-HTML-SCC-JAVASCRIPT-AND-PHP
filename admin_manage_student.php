...
<body>
    <section id="studentnav">
        ...
        <div class="Admin_dashboard">
            <ul>
                ...
                <li><a class="active" href="#">Manage Student</a></li>
    ...
    <section id="manage">
        <div class="card_body">
            ...
            <div class="btn_add">
                <button class="add_student"> <a href="admin_add_student.php">+Add Student</a></button>
            </div>
            <div class="main_container">
                ...
                <div class="table_container">
                    <table class="table_table">
                        ...
                        <tbody> <?php include("manage_student.php"); ?> </tbody>
                    </table>
                </div>
            </div>
        </div>
